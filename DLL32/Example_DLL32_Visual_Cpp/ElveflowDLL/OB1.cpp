...
int main_OB1()
{
	...
	error = OB1_Initialization("01BECD3F", Z_regulator_type__0_200_mbar,Z_regulator_type__0_2000_mbar, Z_regulator_type_m1000_1000_mbar, Z_regulator_type__0_8000_mbar, &MyOB1_ID);
	...
	//Check_Error(error);//error sent if not recognized
	// 
	OB1_Add_Sens(MyOB1_ID, 1, Z_sensor_type_Flow_1000_muL_min, Z_Sensor_digit_analog_Digital, Z_Sensor_FSD_Calib_H2O, Z_D_F_S_Resolution__16Bit, 0);
	////////////////////////
	//
	// Choose calibration
	//
	...
	do {// loop until exit
		...
		{
			//get all the channels and the sensor, it takes about 2 ms
			channel = 1;
