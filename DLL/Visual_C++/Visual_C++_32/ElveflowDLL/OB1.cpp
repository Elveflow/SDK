...
int main_OB1()
{
	...
	error = OB1_Initialization("COM9", 0,0, 0, 0, &MyOB1_ID);
	...
	//Check_Error(error);//error sent if not recognized
	// 
	OB1_Add_Sens(MyOB1_ID, 1, Z_sensor_type_Flow_5000_muL_min, Z_Sensor_digit_analog_Digital, Z_Sensor_FSD_Calib_H2O, Z_D_F_S_Resolution__16Bit, 0);
	////////////////////////
	//
	// Choose calibration
	//
