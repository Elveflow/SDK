function [error] = OB1_Start_Remote_Measurement(OB1_ID, Calib_array_in, longueur)
 % Elveflow Library
 % OB1 Device
 % 
...
error=calllib('Elveflow32', 'OB1_Start_Remote_Measurement' , OB1_ID, Calib_array_in, longueur);
