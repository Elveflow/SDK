...
# dll32dir=os.path.join(fileDi'\DLL32')
# python32dir=os.path.join(fileDir, '..\..\Python_32')

# print(dll32dir)
# print(python32dir)
sys.path.append('C:/Users/David/Documents/ELVESYS/R&D/ESI/SDK_V3_10_00/Python_32/DLL32')#add the path of the library here
sys.path.append('C:/Users/David/Documents/ELVESYS/R&D/ESI/SDK_V3_10_00/Python_32')#add the path of the LoadElveflow.py
