...
def MUX_Set_all_valves (MUX_ID_in, array_valve_in, longueur):
	X_MUX_Set_all_valves=ElveflowDLL.MUX_Set_all_valves
	X_MUX_Set_all_valves.argtypes=[c_int32, POINTER(c_int32), c_int32]
	return X_MUX_Set_all_valves (MUX_ID_in, array_valve_in, longueur)
...
def Elveflow_Calibration_Default (Calib_Array_out, longueur):
	...
	return X_Elveflow_Calibration_Default (Calib_Array_out, longueur)
 ...
 #
# use ctypes c_double*1000 for calibration array
def Elveflow_Calibration_Load (Path, Calib_Array_out, longueur):
	...
	return X_Elveflow_Calibration_Load (Path, Calib_Array_out, longueur)
 ...
 #
# use ctypes c_double*1000 for calibration array
def Elveflow_Calibration_Save (Path, Calib_Array_in, longueur):
	...
	return X_Elveflow_Calibration_Save (Path, Calib_Array_in, longueur)
 ...
 #
# use ctypes c_double*1000 for calibration array
def OB1_Calib (OB1_ID_in, Calib_array_out, longueur):
	X_OB1_Calib=ElveflowDLL.OB1_Calib
	X_OB1_Calib.argtypes=[c_int32, POINTER(c_double*1000), c_int32]
	return X_OB1_Calib (OB1_ID_in, Calib_array_out, longueur)
...
def OB1_Set_Press (OB1_ID, Channel_1_to_4, Pressure, Calib_array_in, Calib_Array_len):
 ...
 #
# use ctypes c_double*1000 for calibration array
def AF1_Calib (AF1_ID_in, Calib_array_out, longueur):
	X_AF1_Calib=ElveflowDLL.AF1_Calib
	X_AF1_Calib.argtypes=[c_int32, POINTER(c_double*1000), c_int32]
	return X_AF1_Calib (AF1_ID_in, Calib_array_out, longueur)
 ...
 #
# use ctypes c_double*1000 for calibration array
def AF1_Get_Press (AF1_ID_in, Integration_time, Calib_array_in, Pressure, longueur):
	...
	return X_AF1_Get_Press (AF1_ID_in, Integration_time, Calib_array_in, Pressure, longueur)
 ...
 #
# use ctypes c_double*1000 for calibration array
def AF1_Set_Press (AF1_ID_in, Pressure, Calib_array_in, longueur):
	X_AF1_Set_Press=ElveflowDLL.AF1_Set_Press
	X_AF1_Set_Press.argtypes=[c_int32, c_double, POINTER(c_double*1000), c_int32]
	return X_AF1_Set_Press (AF1_ID_in, Pressure, Calib_array_in, longueur)
...
def BFS_Set_Filter (BFS_ID_in, Filter_value):
 ...
 #   
 #
def Elveflow_EXAMPLE_PID (PID_ID_in, actualValue, Reset, P, I, targetValue, PID_ID_out, value):
	...
	return X_Elveflow_EXAMPLE_PID (PID_ID_in, actualValue, Reset, P, I, targetValue, PID_ID_out, value)
 ...
 # 
 #
def MUX_Wire_Set_all_valves (MUX_ID_in, array_valve_in, longueur):
	...
	return X_MUX_Wire_Set_all_valves (MUX_ID_in, array_valve_in, longueur)
...
def OB1_Set_All_Press (OB1_ID, Pressure_array_in, Calib_array_in, Pressure_Array_Len, Calib_Array_Len):
	...
	X_OB1_Set_All_Press.argtypes=[c_int32, POINTER(c_double*4), POINTER(c_double*1000), c_int32, c_int32]
...
def M_S_R_D_Destructor (M_S_R_D_ID):
 ...
 # valve for a session.
 #
def MUX_DRI_Send_Command (MUX_DRI_ID_in, Action, Answer, longueur):
	X_MUX_DRI_Send_Command=ElveflowDLL.MUX_DRI_Send_Command
	X_MUX_DRI_Send_Command.argtypes=[c_int32, c_uint16, c_char_p, c_int32]
	return X_MUX_DRI_Send_Command (MUX_DRI_ID_in, Action, Answer, longueur)
...
def M_S_R_D_Set_Filt (M_S_R_D_ID, Channel_1_to_4, ONOFF):
 ...
 #
def OB1_Start_Remote_Measurement (OB1_ID, Calib_array_in, longueur):
	...
	return X_OB1_Start_Remote_Measurement (OB1_ID, Calib_array_in, longueur)
...
def PID_Set_Running_Remote (Regulator_ID, Channel_1_to_4, Running):
 ...
 # (get_remote_data, set_remote_target, remote_triggers) are recommended.
 #
def AF1_Start_Remote_Measurement (AF1_ID, Calib_array_in, longueur):
	...
	return X_AF1_Start_Remote_Measurement (AF1_ID, Calib_array_in, longueur)
...
def BFS_Stop_Remote_Measurement (BFS_ID):
 ...
 #            Temperature: Celcius
 #
def BFS_Get_Remote_Data (BFS_ID, Temperature, Density, Flow):
	...
	return X_BFS_Get_Remote_Data (BFS_ID, Temperature, Density, Flow)
