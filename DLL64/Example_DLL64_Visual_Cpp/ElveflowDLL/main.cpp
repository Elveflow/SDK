...
int main()
{
	...
	////////////////////////
	do {
		cout << "select instrument: OB1, AF1, F_S_R (for Flow Reader or Sensor Reader), M_S_R_D (for Sensor Reader able to read digital sensors), MUX, MUX DRI (for MUX Distribution, Distributor, Recirculation or Injection), or BFS (Bronkhorst Mini-Cori Flow)" << endl;
