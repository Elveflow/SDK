...
int main_F_SReader()
{
	...
	error = F_S_R_Initialization("MySensorReader", Z_sensor_type_Flow_1000_muL_min, Z_sensor_type_none, Z_sensor_type_Press_340_mbar, Z_sensor_type_none, &MyF_S_Reader_ID);//remember that sensors 1-2 and 3-4 should be the same kind
