function [error] = MUX_Wire_Set_all_valves(MUX_ID_in, array_valve_in, longueur)
 % Elveflow Library
 % Mux Device
 % 
...
error=calllib('Elveflow32', 'MUX_Wire_Set_all_valves' , MUX_ID_in, array_valve_in, longueur);
