function [error] = M_S_R_D_Get_Remote_Data(M_S_R_D_ID, Channel_1_to_4, Sens_Data)
 % Elveflow Library
 % MSRD Device
 % 
...
error=calllib('Elveflow32', 'M_S_R_D_Get_Remote_Data' , M_S_R_D_ID, Channel_1_to_4, Sens_Data);
