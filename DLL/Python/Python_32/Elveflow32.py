# Python wrapper for ElveFlow32DLL
# Version : 3.10
# Author : Elveflow
...
from ctypes import *
ElveflowDLL=CDLL('C:/dev/SDK/DLL32/DLL32/Elveflow32.dll')# change this path 
...
def OB1_Calib (OB1_ID_in):
 ...
 #
# use ctypes c_double*1000 for calibration array
def OB1_Set_Press (OB1_ID, PressureTarget, Channel_1_to_4):
	X_OB1_Set_Press=ElveflowDLL.OB1_Set_Press
	X_OB1_Set_Press.argtypes=[c_int32, c_double, c_int32]
	return X_OB1_Set_Press (OB1_ID, PressureTarget, Channel_1_to_4)
