function [error] = Elveflow_Calibration_Load(Path, Calib_Array_out, longueur)
 % Elveflow Library
 % OB1-AF1 Device
 % 
...
error=calllib('Elveflow32', 'Elveflow_Calibration_Load' , Path, Calib_Array_out, longueur);
