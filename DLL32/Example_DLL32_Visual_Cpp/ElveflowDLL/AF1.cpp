...
#include "AF1.h"
#include <Elveflow32.h>//modify the additional include directory, you may need to remove, reload all resource file (ElveflowXX.h and so on)
using namespace std;
...
int main_AF1()
{
	...
	{
		Elveflow_Calibration_Load("", Calibration,1000);//load the file contain in the path, if no path or non valid path, prompt ask the user to choose the file
	}
	else if (answer == "new")
	{
