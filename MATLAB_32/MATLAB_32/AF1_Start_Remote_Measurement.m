function [error] = AF1_Start_Remote_Measurement(AF1_ID, Calib_array_in, longueur)
 % Elveflow Library
 % AF1 Device
 % 
...
error=calllib('Elveflow32', 'AF1_Start_Remote_Measurement' , AF1_ID, Calib_array_in, longueur);
